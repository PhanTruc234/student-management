...
@section('content')
    ...
    <form action="{{ route('subjects.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="credit" name="credit" value="{{ old('credit') }}" required min="1">
            @error('credit')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="total_sessions" name="total_sessions" value="{{ old('total_sessions') }}" required min="1" max="50">
